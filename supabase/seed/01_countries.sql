-- Full country reference list (ISO 3166-1 alpha-2). Static, cheap, safe to
-- seed in full even though only a handful will have universities in the MVP.
...
('CR','Costa Rica'),('CI',E'Côte d\'Ivoire'),('HR','Croatia'),('CU','Cuba'),('CY','Cyprus'),
